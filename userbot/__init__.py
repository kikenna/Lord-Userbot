...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "```『Newbie-Bot Siap Digunakan』```")
    return
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("Newbie-bot, Buat Userbot Mu Sendiri [Tekan Disini](https://github.com/Yahiko963/Lord-Userbot.git)")
            else:
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@UserButt"):
                ...
                result = builder.article(
                    "**Lord✗Userbot**",
                    text="""**Anda Bisa Membuat bot Anda Sendiri Dengan Cara:** [Tekan Disini](t.me/Lorduserbot_Group)""",
                    buttons=[
                        [
                            custom.Button.url(
                                "Repo Newbie-bot",
                                "https://github.com/Yahiko963/Lord-Userbot"),
                            custom.Button.url(
                                "Pemilik Repo",
                                "t.me/Lubego666")],
                    ],
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # pylint:disable=E0602
                ...
                reply_pop_up_alert = f"Harap Deploy bot Anda Sendiri, Jangan Menggunakan Milik  {ALIVE_NAME} ツ"
